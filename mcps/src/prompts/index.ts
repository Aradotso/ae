      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            "",
            "Please:",
            "1. Use search_stores to find nearby stores on Instacart",
            "2. Use search_products to find what I want with prices",
            "3. Show me the best options and help me build a cart",
            "4. Use create_cart to set up the order (ask me to confirm the total first)",
          ].join("\n"),
        },
      }],
    })
